    ...
    <div class="container">
        ...
        <form action="{{ route('studentUpdate',['id'=>$student->id]) }}" method="Post">
            ...
            <div class="form-group">
                ...
                <input type="text" id="name" name="name" placeholder="Enter your full name" required value="{{ $student->name }}">
            </div>
            ...
            <div class="form-group">
                ...
                <textarea id="address" name="address" placeholder="Enter your full address" >{{$student->address}}</textarea>
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="bacGrade" name="bacGrade" min="0" max="20" step="0.01" placeholder="e.g., 15.75" required value="{{$student->bacGrade}}">
